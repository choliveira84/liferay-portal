...
@Component(
	immediate = true,
	property = "ddm.form.field.type.name=google-maps-predictor",
	service = {
		DDMFormFieldValueRenderer.class,
		GoogleMapsPredictorDDMFormFieldValueRenderer.class
	}
)
public class GoogleMapsPredictorDDMFormFieldValueRenderer
